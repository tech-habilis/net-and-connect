  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button className="bg-lime-200 text-black px-4 py-1.5 rounded text-xs font-bold hover:bg-[#B5E547] transition-colors uppercase flex items-center gap-1 cursor-pointer">
          DÉCOUVRIR
